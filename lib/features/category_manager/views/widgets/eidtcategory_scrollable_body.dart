...
class ScrollableBody extends StatelessWidget {
  const ScrollableBody({super.key});
                    ...
                    children: [
                      ...
                      ...viewModel.dynamicFields.map((field) {
                        return DynamicFieldRow(
                          ...
                          onRequiredChanged: (isRequired) => viewModel
                              .updateFieldRequired(field.id, isRequired),
                      ...
                      TextButton.icon(
                        ...
                        style: TextButton.styleFrom(
                          backgroundColor: WebColors.buttonBlue.withOpacity(
                            0.1,
                          ),
