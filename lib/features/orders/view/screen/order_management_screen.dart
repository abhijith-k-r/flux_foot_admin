...
import 'package:flux_foot_admin/features/orders/view/widgets/ordermanagement_adminstatus_dialog.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    onPressed: () async {
                                      ...
                                      double sEarning =
                                          (order['sellerEarning'] ?? 0.0)
                                              .toDouble();
                                      double aCommission =
                                          (order['adminCommission'] ?? 0.0)
                                              .toDouble();
                                      ...
                                      if (order['sellerId'] != null) {
                                        try {
                                          ...
                                          if (currentBalance < sellerEarning) {
                                            deduction =
                                                currentBalance; // Cap at current balance to avoid negative
                                          }
                                          ...
                                          _
                                        ) {} // Handle if doc not strictly initialized
                                      }
                                      ...
                                      if (customerId != null) {
                                        await FirebaseFirestore.instance
                                            ...
                                            .add({
                                              ...
                                              'body':
                                                  "Your refund for '$productName' (#${orderId.substring(0, 8).toUpperCase()}) has been processed successfully.",
                                              'isRead': false,
                                              'createdAt':
                                                  FieldValue.serverTimestamp(),
                                            });
                            ...
                            SizedBox(
                              width: double.infinity,
                              child: ElevatedButton.icon(
                                onPressed: () => showAdminStatusDialog(
                                  context,
                                  orderId,
                                  order['status'],
                                ),
